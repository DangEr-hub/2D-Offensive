...
if(round_ended == true && oDraw.RespawnMenu == false){
	...
	if(global.game_struct.Rounds_win < (MAX_ROUNDS/2 + 1) && global.game_struct.Rounds_lost < (MAX_ROUNDS/2 + 1)){
		//global.game_struct.Kills_per_round[global.game_struct.Current_round] = kills;
		//global.game_struct.Headshots_per_round[global.game_struct.Current_round] = headshots;
