...
Acceleration = min(.5 * get_rank_boost(global.player_rating_struct.Enemy_ep[global.player_rating_struct.Current_game]), .7);
Friction = .75;
MaxSpeed = min(2.5 * get_rank_boost(global.player_rating_struct.Enemy_ep[global.player_rating_struct.Current_game]), 5);
MoveDirection  = 0;
MoveTime = 0;
XSpeed = 0;
YSpeed = 0;
