event_inherited();
weapon_description_width = max(700 * global.gui_scale, 1080);
weapon_description_height = max(192 * global.gui_scale, 256);
...
grid_height = ITEM_CELL_HEIGHT * global.gui_scale * 3; 
