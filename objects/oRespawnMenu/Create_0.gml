...
with(zui_create(zui_get_width() * .5, offset_position_y + grid_height + button_height*1.5, objUIButton)){
	zui_set_anchor(0.5, 0);
	zui_set_width(other.button_width);
	zui_set_height(other.button_height);
	caption = "Main menu";
...
with(zui_create(zui_get_width() * .5, offset_position_y + grid_height + button_height*1.5*2, objUIButton)){
	zui_set_anchor(0.5, 0);
	zui_set_width(other.button_width);
	zui_set_height(other.button_height);
	caption = "Exit";
