function Haze_Documentation() {
	...
	**USAGE**
	...
	Arguments:
	    views_used: Set it to true if you're using views/camera.
	...
	*/
	...
	You can modify the haze shader properties in oHazeController's Create event.
