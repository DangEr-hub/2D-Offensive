...
function ItemDataBase(){
	...
	WeaponStats(Item.SSG08, "SSG 08", 3 * game_get_speed(gamespeed_fps), 825, 110, 100, 10, "Primary", 2, 30, snd_SSG08, 15, 2, false,
	...
	WeaponStats(Item.MP9, "MP9", 1.25 * game_get_speed(gamespeed_fps), 685, 28, 280, 30, "Primary", 4, 5, snd_MP9, 1.5, 0.8, true,
	...
	WeaponStats(Item.awm, "AWM", 3.25 * game_get_speed(gamespeed_fps), 900, 118, 50, 5, "Primary", 1, 30, snd_awm, 30, 2, false,
	...
	WeaponStats(Item.Dragunov, "Dragunov", 3.75 * game_get_speed(gamespeed_fps), 890, 94, 45, 15, "Primary", 2, 20, snd_Dragunov, 20, 1.5, false,
	...
	WeaponStats(Item.CZ75, "CZ-75", 2 * game_get_speed(gamespeed_fps), 585, 23, 96, 15, "Secondary", 2, 5, snd_CZ75, 1, 1, true,
