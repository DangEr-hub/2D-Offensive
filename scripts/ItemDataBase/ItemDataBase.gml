...
function ItemDataBase(){
	...
	global.ItemIndex[# Item.Dragunov, ItemStat.attach_sockets] = { scope: [-17, -7], barrel: [3, -3], grip: [1, 7], suppressor: [42, -5] };
	...
	global.ItemIndex[# Item.MAC11, ItemStat.attach_sockets] = { barrel: [15, -8], grip: [10, 1], suppressor: [30, -11] };
	...
	WeaponStats(Item.AKM, "AKM", 2 * game_get_speed(gamespeed_fps), 775, 36, 270, 30, "Primary", 8, 6, snd_AKM, 5, 1.25, true,
	...
	WeaponStats(Item.DesertEagle, "Desert Eagle", 1.75 * game_get_speed(gamespeed_fps), 700, 53, 70, 7, "Secondary", 4, 11, snd_DesertEagle, 7, 2, false,
	...
	WeaponStats(Item.Spas, "Spas-12", .75 * game_get_speed(gamespeed_fps), 400, 33, 120, 12, "Primary", 5, 30, snd_Spas, 15, 2, false,
	...
	WeaponStats(Item.SSG08, "SSG 08", 3 * game_get_speed(gamespeed_fps), 850, 110, 100, 10, "Primary", 2, 30, snd_SSG08, 15, 2, false,
	...
	WeaponStats(Item.MAC11, "MAC11", 1.5 * game_get_speed(gamespeed_fps), 580, 29, 300, 30, "Primary", 3, 6, snd_MAC11, 2, 1, true,
	15, 20, -9, 9, 0.025, 1.5, 2, .015, 1, 5, .9, 0, WEAPON_CLASS.SUBMACHINE_GUN, .9, .57, .00058, .1 * game_get_speed(gamespeed_fps), .89, 105, .5, 9, false, ".380 ACP", CALIBER.LOW);
	...
	WeaponStats(Item.SG550, "SIG SG550", 2.5 * game_get_speed(gamespeed_fps), 790, 43, 300, 30, "Primary", 10, 7, snd_SG550, 2, 1.75, true,
	...
	WeaponStats(Item.Javelin, "FGM-148", 1.5 * game_get_speed(gamespeed_fps), 490, 138, 50, 1, "Primary", 25, 15, snd_Javelin, 15, 5, false,
	...
	WeaponStats(Item.Glock, "Glock-17", 1.25 * game_get_speed(gamespeed_fps), 500, 29, 240, 24, "Secondary", 4, 9, snd_Glock, 3, 1, false,
	...
	WeaponStats(Item.MK18, "MK18", 2.1 * game_get_speed(gamespeed_fps), 715, 33, 700, 30, "Primary", 7, 5.5, snd_MK18, 2, 1, true,
	...
	WeaponStats(Item.m4a1, "M4A1", 2.5 * game_get_speed(gamespeed_fps), 730, 34, 300, 25, "Primary", 5, 6, snd_m4a1, 2.5, 1, true,
	...
	global.ItemIndex[#Item.m4a1, ItemStat.has_suppressor] = Item.advanced_suppressor; ///Military suppressor
	...
	WeaponStats(Item.awm, "AWM", 3.25 * game_get_speed(gamespeed_fps), 1000, 118, 50, 5, "Primary", 1, 30, snd_awm, 30, 2, false,
	...
	WeaponStats(Item.Dragunov, "Dragunov", 3.75 * game_get_speed(gamespeed_fps), 950, 94, 45, 15, "Primary", 2, 20, snd_Dragunov, 20, 1.5, false,
	...
	global.ItemIndex[#Item.Dragunov, ItemStat.has_scope] = Item.two_scope;
	...
	global.ItemIndex[#Item.Dragunov, ItemStat.Defense] = 0; ///Flag, ze je to semi-automatic
	...
	WeaponStats(Item.usp, "USP", 1.75 * game_get_speed(gamespeed_fps), 580, 35, 350, 15, "Secondary", 3, 8, snd_usp, 2, 1, false,
	...
	global.ItemIndex[#Item.usp, ItemStat.has_suppressor] = Item.advanced_suppressor;
	...
	WeaponStats(Item.p250, "P250", 1.75 * game_get_speed(gamespeed_fps), 600, 33, 105, 15, "Secondary", 4, 7, snd_p250, 2, 1, false,
	15, 15, 1, 4, .5, 3.75, 2, .0075, 0, 5.9, .99, 0, WEAPON_CLASS.PISTOL, .93, .5, .00029, ceil(.23 * game_get_speed(gamespeed_fps)), .95, 40, 1, 7, false, "9x19 mm", CALIBER.LOW);
	...
	WeaponStats(Item.tec9, "TEC-9", 1.9 * game_get_speed(gamespeed_fps), 615, 27, 180, 18, "Secondary", 5, 7, snd_Tec9, 2, 1.1, false,
	7, 12, 1, 3, .025, 2.5, 3, .00725, 2, 10, .95, 0, WEAPON_CLASS.PISTOL, .975, .71, .00037, ceil(.37 * game_get_speed(gamespeed_fps)), .98, 70, 1, 7, false, "9x19 mm", CALIBER.LOW);
	...
	global.ItemIndex[#Item.advanced_suppressor, ItemStat.usable] = true;
	...
	WeaponStats(Item.basic_machine_gun, "Basic machine gun", 3 * game_get_speed(gamespeed_fps), 600, 33, 500, 50, "Primary", 10, 7, snd_machine_gun, 10, 2, false,
	...
	WeaponStats(Item.famas, "FAMAS", ceil(1.89 * game_get_speed(gamespeed_fps)), 680, 30, 250, 25, "Primary", 5, 7, snd_Famas, 2, 1, true,
	...
	WeaponStats(Item.galil, "Galil", 1.75 * game_get_speed(gamespeed_fps), 700, 36, 270, 30, "Primary", 10, 6, snd_galil, 5, 2, true,
	...
	WeaponStats(Item.steel_knife, "Steel knife", .5 * game_get_speed(gamespeed_fps), 48, 27,-1, -1, "Tertiary", 0, 10, snd_knife, 5, 2, false,
	...
	global.ItemIndex[#Item.range_finder, ItemStat.usable] = true;
